...
DB_HOST_DW='dw' #host name resolves to the name of the service that starts the db?
DB_PORT_DW=5432
...
if __name__ == '__main__':
    source_conn = connect(name=DB_NAME_DW, user=DB_USER_DW, pw=DB_PASS_DW, host=DB_HOST_DW, port=DB_PORT_DW)
    source_fetched=source_fetch(conn=source_conn) #returns source database
    ...
    dw_conn = connect(name=DB_NAME_DW, user=DB_USER_DW, pw=DB_PASS_DW, host=DB_HOST_DW, port=DB_PORT_DW)
